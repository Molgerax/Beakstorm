...
namespace DynaMak.Utility
{
    public static class ExtensionMethods
    {
        ...
        public static void SetVolume(this ComputeShader cs, int kernelIndex, VolumeTexture volumeTexture, int textureID, int centerID, int boundsID)
        {
        ...
        public static void SetVolume(this ComputeShader cs, int kernelIndex, VolumeTexture volumeTexture, int textureID, int centerID, int boundsID, int resolutionID)
        {
            if (volumeTexture.IsInitialized == false)
            {
                cs.SetTexture(kernelIndex, textureID, Texture2D.blackTexture);
        ...
        public static void SetVolume(this ComputeShader cs, int kernelIndex, VolumeTexture volumeTexture, string prefix, bool useResolution = true)
        {
        ...
        public static void SetMesh(this ComputeShader cs, int kernelIndex, MeshAsset ma, int vertexBufferID,
                                            int indexBufferID, int vertexBufferStrideID, int vertexBufferCountID)
        {
            cs.SetBuffer(kernelIndex, vertexBufferID, ma.VertexBuffer);
            cs.SetBuffer(kernelIndex, indexBufferID, ma.IndexBuffer);
            cs.SetInt(vertexBufferStrideID, ma.VertexBuffer.stride);
            cs.SetInt(vertexBufferCountID, ma.VertexBuffer.count);
        }
        
        public static void SetFracturedMesh(this ComputeShader cs, int kernelIndex, FracturedMeshAsset fma, int vertexBufferID,
            int indexBufferID, int vertexBufferStrideID, int vertexBufferCountID,
            int pivotTexID, int indexTexID, int lowerBoundsID, int upperBoundsID)
        {
            cs.SetMesh(kernelIndex, fma, vertexBufferID, indexBufferID, vertexBufferStrideID, vertexBufferCountID);
            
            cs.SetTexture(kernelIndex, pivotTexID, fma.PivotTexture);
            cs.SetTexture(kernelIndex, indexTexID, fma.IndexTexture);
            cs.SetVector(lowerBoundsID, fma.Bounds.center);
            cs.SetVector(upperBoundsID, fma.Bounds.size);
        }


        public static void Dispatch(this ComputeShader cs, int kernelIndex, Vector3Int resolution, int threadBlockSize)
        {
            cs.Dispatch(kernelIndex, resolution.x / threadBlockSize, resolution.y / threadBlockSize, resolution.z / threadBlockSize);
        }
        
        
        
        public static void Dispatch(this ComputeShader cs, int kernelIndex, DynaParticle dynaParticle)
        {
            cs.Dispatch(kernelIndex, Math.Max(dynaParticle.GetGroupCount(), 1), 1, 1);
        }
        ...
        public static void SetVolume(this MaterialPropertyBlock propertyBlock, VolumeTexture volumeTexture, int textureID, int centerID, int boundsID)
        {
        ...
        public static void SetVolume(this MaterialPropertyBlock propertyBlock, VolumeTexture volumeTexture, int textureID, int centerID, int boundsID, int resolutionID)
        {
            propertyBlock.SetTexture(textureID, volumeTexture.Texture);
            propertyBlock.SetVector(centerID, volumeTexture.Center);
            propertyBlock.SetVector(boundsID, volumeTexture.Bounds);
        ...
        public static void SetVolume(this MaterialPropertyBlock propertyBlock, VolumeTexture volumeTexture, string prefix, bool useResolution = true)
        {
        ...
        private static int[] _vector3ToArray = new int[3];
        /// <summary>
        ...
        public static bool HasFileExtension(this UnityEngine.Object o, string extension)
        {
        ...
        public static bool HasFileExtension(this UnityEngine.Object o, string[] extensions)
        {
            string path = AssetDatabase.GetAssetPath(o);
